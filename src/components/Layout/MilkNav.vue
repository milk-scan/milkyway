<template>
    <nav :class="twMerge('bg-blueberry-700 border-gray-200 dark:bg-gray-900', colors.primary)">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center">
                <!-- <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3" alt="Flowbite Logo" /> -->
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">MilkScan</span>
            </a>
            <div class="flex items-center md:order-2">
                ...
                <!-- Dropdown menu -->
                <div :class="twMerge('z-50 hidden my-4 text-base list-none bg-blueberry-700 divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600', colors.primary)"
                    id="user-dropdown">
                    <div class="px-4 py-3">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                <ul
                    :class="twMerge('flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-blueberry-700 md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700', colors.primary)">
                    <li>
                        <a href="#"
