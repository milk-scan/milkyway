export default {
    ...
    legend: ({ props }) => ({
        class: [
            ...
            // States
            { '': props.toggleable },
            { 'focus:outline-none focus:outline-offset-0 focus:ring-2 focus:ring-blueberry-600 ring-inset dark:focus:ring-blueberry-500': props.toggleable }
        ]
    }),
    toggler: ({ props }) => ({
        class: [
            ...
            { 'focus:outline-none focus:outline-offset-0 focus:ring-2 focus:ring-inset focus:ring-blueberry-600 dark:focus:ring-blueberry-500': props.toggleable },
