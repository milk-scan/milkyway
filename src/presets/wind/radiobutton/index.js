    ...
    input: ({ props, state }) => ({
        class: [
            ...
            // Colors
            {
                ...
                'border-blueberry-500 dark:border-blueberry-400': props.value == props.modelValue && props.value !== undefined
            },

            // States
            {
                'outline-none outline-offset-0': !props.disabled && state.focused,
                'ring-2 ring-offset-2 ring-offset-surface-0 dark:ring-offset-surface-800 ring-blueberry-500 dark:ring-blueberry-400': !props.disabled && state.focused,
