export default {
    ...
    toggler: {
        class: [
            ...
            'focus:outline-none focus:outline-offset-0 focus-visible:ring-2 focus-visible:ring-blueberry-600 focus-visible:ring-inset dark:focus-visible:ring-blueberry-500',
