export default {
    ...
    header: {
        class: ['rounded-md', 'outline-none', 'focus-visible:outline-none focus-visible:outline-offset-0 focus-visible:ring focus-visible:ring-blueberry-400/50 dark:focus-visible:ring-blueberry-300/50']
    },
